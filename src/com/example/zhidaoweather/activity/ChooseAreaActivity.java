...
public class ChooseAreaActivity extends Activity
{
	...
	private boolean isFromeWeatherActivity; //是否从WeatherActivity中跳转过来
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if(sdf.getBoolean("city_selected", false) && !isFromeWeatherActivity) //已经选择了城市，且不是从WeatherActivity跳转过来的，才会直接跳转到WeatherActivity
		{
